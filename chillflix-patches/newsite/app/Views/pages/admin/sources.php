...
<main class="cf-admin page-pad-top">
  <div class="container cf-admin-wrap">
    ...
    <div class="cf-admin-panel" id="relay-panel">
      ...
      <p class="muted" style="margin:1rem 0 0;font-size:.82rem;color:rgba(255,255,255,.45)">
        Second CF account: create Worker → paste <code>workers/yoru-relay.js</code> → set encrypted <code>YORU_RELAY_SECRET</code> → Deploy → Add URL + secret above → Test → Save.
