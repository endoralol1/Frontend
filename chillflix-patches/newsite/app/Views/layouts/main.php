...
<head>
    ...
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>" fetchpriority="high">
    ...
    <link rel="stylesheet" href="<?= e(asset('css/app.css')) ?>?v=20260729-top10-ribbon">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260729-top10-ribbon" defer></script>
