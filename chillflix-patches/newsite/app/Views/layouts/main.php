...
<head>
    ...
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260729-hdrClear" fetchpriority="high">
    ...
    <link rel="stylesheet" href="<?= e(asset('css/app.css')) ?>?v=20260729-notopshadow">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260729-hero" defer></script>
