...
<head>
    ...
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260731-sidebar3" fetchpriority="high">
    ...
    <link rel="stylesheet" href="<?= e(asset('css/app.css')) ?>?v=20260731-sidebar3">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260731-sidebar3" defer></script>
