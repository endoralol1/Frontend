...
<head>
    ...
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260729-mobilecards1" fetchpriority="high">
    ...
    <link rel="stylesheet" href="<?= e(asset('css/app.css')) ?>?v=20260729-mobilecards1">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260729-phoneui1" defer></script>
