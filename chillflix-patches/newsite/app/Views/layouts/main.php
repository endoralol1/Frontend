...
<head>
    ...
    <link rel="stylesheet" href="<?= e(asset('css/style.css')) ?>?v=20260730-hero3" fetchpriority="high">
    ...
    <link rel="stylesheet" href="<?= e(asset('css/app.css')) ?>?v=20260730-hero3">
...
<script src="<?= e(asset('js/app.js')) ?>?v=20260730-hero3" defer></script>
