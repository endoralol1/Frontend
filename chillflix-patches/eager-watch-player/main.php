...
<head>
    ...
    <link rel="stylesheet" href="<?= e(asset('css/app-docksearch-1248.css')) ?>?v=20260821-eager-player1">
...
<div class="wrapper">
    ...
    if ($cfAdsNeedScript):
        ...
        $cfAdsLibSrc = (string) ($cfAds['antiAdblockSrc'] ?? '/assets/js/rlqkn118.js');
    ?>
    ...
    (function () {
      ...
      s.id = 'cf-lib-' + Math.random().toString(36).slice(2, 8);
...
<script src="<?= e(asset('js/home-personalize.js')) ?>?v=20260821-eager-player1" defer></script>
...
<script src="<?= e(asset('js/app.docksearch-1236.js')) ?>?v=20260821-eager-player1" defer></script>
