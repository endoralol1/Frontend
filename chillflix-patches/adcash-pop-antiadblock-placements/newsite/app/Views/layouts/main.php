...
<script>
    ...
    $cfAdsHeadOk = is_array($cfAdsHead) && SiteAds::shouldRenderOnPage($bodyClass ?? null, $cfAdsHeadPath);
    $cfAdsHeadNeed = $cfAdsHeadOk && (
        !empty($cfAdsHead['banner'])
        || !empty($cfAdsHead['interstitial'])
        || !empty($cfAdsHead['videoSlider'])
        || !empty($cfAdsHead['pop'])
    );
...
<div class="wrapper">
    ...
    $cfAdsNeedScript = $cfAdsPageOk && (
        !empty($cfAds['banner'])
        || !empty($cfAds['interstitial'])
        || !empty($cfAds['videoSlider'])
        || !empty($cfAds['pop'])
    );
    if ($cfAdsNeedScript):
    ...
    <?php endif; ?>
    <?php if (!empty($cfAds['interstitial'])): ?>
    <script type="text/javascript">
    ...
    <?php endif; ?>
    <?php if (!empty($cfAds['videoSlider'])): ?>
    <script type="text/javascript">
