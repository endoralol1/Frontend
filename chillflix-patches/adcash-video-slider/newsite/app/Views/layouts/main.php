...
<div class="wrapper">
    ...
    <?php
    $cfAds = SiteAds::get();
    $cfAdsPageOk = SiteAds::shouldRenderOnPage($bodyClass ?? null);
    $cfAdsNeedScript = $cfAdsPageOk && (
        !empty($cfAds['banner']) || !empty($cfAds['interstitial']) || !empty($cfAds['videoSlider'])
    );
    if ($cfAdsNeedScript):
    ?>
    <!-- AdCash (admin: /admin/ads) -->
    <script id="aclib" type="text/javascript" src="//acscdn.com/script/aclib.js"></script>
    <?php if (!empty($cfAds['interstitial'])): ?>
    <script type="text/javascript">
        aclib.runInterstitial({
            zoneId: <?= json_encode((string) $cfAds['interstitialZone'], JSON_UNESCAPED_SLASHES) ?>,
        });
    </script>
    <?php endif; ?>
    ...
    <script type="text/javascript">
        aclib.runVideoSlider({
            zoneId: <?= json_encode((string) $cfAds['videoSliderZone'], JSON_UNESCAPED_SLASHES) ?>,
        });
    </script>
    <?php endif; ?>
    ...
    <div class="container" id="cf-adcash-banner">
        <script type="text/javascript">
            aclib.runBanner({
                zoneId: <?= json_encode((string) $cfAds['bannerZone'], JSON_UNESCAPED_SLASHES) ?>,
            });
        </script>
    </div>
    <?php endif; ?>
