...
/**
 * Site ad network settings (AdCash banner + interstitial + video slider).
...
final class SiteAds
{
    ...
    /** @return array{enabled:bool,banner:bool,interstitial:bool,videoSlider:bool,bannerZone:string,interstitialZone:string,videoSliderZone:string,updated:int} */
    ...
    public static function videoSliderOn(): bool
    {
        $s = self::get();
        return !empty($s['enabled']) && !empty($s['videoSlider']);
    }
    ...
    private static function normalize(array $data): array
    {
        ...
        return [
            ...
            // New unit: default on when key missing so first deploy enables the test zone.
