...
final class SourcesService
{
    ...
    public const CATALOG = [
        ...
        'yesmovies' => 'YesMovies', // ww2.yesmovies.ag → ployan.me direct HLS
        'fzmovies' => 'FzMovies', // fzmovies.host progressive MP4/MKV mirrors
        ...
        // moonflix / megasource also listed above near netmirror for admin order
    ];
