...
if ($action === 'dashboard') {
    ...
    api_json([
        ...
        'discovery' => [
            'batch_size' => (int) get_setting('discovery_batch_size', '1000'),
            'interval_minutes' => (int) get_setting('discovery_interval_minutes', '1'),
            'rate_limit_per_hour' => (int) get_setting('discovery_rate_limit_per_hour', '50000'),
...
if ($action === 'discovery_get') {
    ...
    api_json([
        ...
        'runs' => $runs,
        'settings' => [
            'discovery_batch_size' => (int) get_setting('discovery_batch_size', '1000'),
            'discovery_interval_minutes' => (int) get_setting('discovery_interval_minutes', '1'),
            'discovery_rate_limit_per_hour' => (int) get_setting('discovery_rate_limit_per_hour', '50000'),
            'discovery_auto_enabled' => get_setting('discovery_auto_enabled', '1'),
...
if ($action === 'discovery_save' && $method === 'POST') {
    ...
    $batch = max(1, min(10000, (int) ($body['discovery_batch_size'] ?? 1000)));
    $interval = max(1, min(1440, (int) ($body['discovery_interval_minutes'] ?? 5)));
    $rate = max(1, min(1000000, (int) ($body['discovery_rate_limit_per_hour'] ?? 50000)));
    $auto = !empty($body['discovery_auto_enabled']) ? '1' : '0';
    $turbo = !empty($body['discovery_turbo_fast']) ? '1' : '0';
    ...
    set_setting('discovery_auto_enabled', $auto);
    set_setting('discovery_turbo_fast', $turbo);
