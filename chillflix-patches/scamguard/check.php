...
if ($siteUnavailable) {
    ...
    // Discovery drafts are indexable so domain searches can find ScamGuard early.
    // Keep title/description clearly provisional — never claim a finished verdict.
    $pageTitle = $domain . ' Scam Check (Provisional · unfinished) | ' . $siteName;
    $pageDescription = 'Is ' . $domain . ' a scam? ' . $siteName
        . ' has a provisional discovery scan for ' . $domain
        . ' (not a finished live trust test yet). Open the report or rescan for the full check.';
...
<section class="section container result-page">
    ...
    $highlightRow = static function (array $s, bool $positive): array {
        ...
        $goodMap = [
            ...
            'Cookie policy' => 'A cookie policy / preferences link was found',
            ...
            'Scamadviser' => 'Scamadviser meta trust score looks solid',
            ...
            'Engine verdict' => 'Our scan engine found no major red flags',
        ...
        $badMap = [
            ...
            'Cookie policy' => 'No cookie policy / preferences link was found',
            'Tranco traffic rank' => 'Low or unranked traffic — small or new audience',
            'AI risk judgment' => 'AI review suggests some caution',
            'Engine verdict' => 'Use caution — no scam-list hit, but not enough proof to call it safe',
            ...
            'Review consensus' => 'Review / reputation picture is mixed or thin',
            ...
            'Scamadviser' => 'Scamadviser meta trust score looks weak',
