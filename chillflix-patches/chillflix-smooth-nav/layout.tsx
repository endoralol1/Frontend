...
import { InstantNavPrefetch } from "@/components/instant-nav-prefetch"
import { SmoothClientNav } from "@/components/smooth-client-nav"
...
export default async function RootLayout({ children, modal }: RootLayoutProps) {
  ...
  return (
    <html lang={locale} className="dark" suppressHydrationWarning>
      ...
      >
        <Script src="/bot-shield.js" strategy="beforeInteractive" />
        <HolyLoader color="#14b8a6" height={2} />
