    ...
    <section class="cf-admin-panel" aria-label="Ad controls" style="margin-top:1rem">
      ...
      <div class="cf-ads-row">
        <div class="cf-ads-copy">
          ...
          <small>Master switch for banner + interstitial</small>
        </div>
      ...
      <div class="cf-ads-row">
        <div class="cf-ads-copy">
          ...
          <small>Zone <?= e((string) $ads['interstitialZone']) ?> · AdCash pop/interstitial</small>
        </div>
...
(function () {
  ...
  function paint(d) {
    if (!d) return;
    [['ads-enabled','enabled'],['ads-banner','banner'],['ads-interstitial','interstitial']].forEach(function (pair) {
  ...
  ['ads-enabled','ads-banner','ads-interstitial'].forEach(function (id) {
