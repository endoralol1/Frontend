  ...
  <div class="container cf-admin-wrap">
    ...
    <div class="cf-admin-head">
      ...
      <p class="muted" style="margin:.35rem 0 0;color:rgba(255,255,255,.55);font-size:.88rem">
        Toggle each unit on/off. Pop placements only affect Pop / Pop-under.
      </p>
    </div>
    ...
    <section class="cf-admin-panel cf-ads-panel" aria-label="Ad units" style="margin-top:1rem">
      ...
      <div class="cf-ads-row">
        <div class="cf-ads-copy">
          ...
          <small>Zone <?= e((string) $ads['bannerZone']) ?> · site-wide when on</small>
        </div>
        <button type="button" class="cf-admin-switch<?= !empty($ads['banner']) ? ' on' : '' ?>" id="ads-banner" role="switch" aria-checked="<?= !empty($ads['banner']) ? 'true' : 'false' ?>" aria-label="Toggle banner ad"></button>
      </div>

      <div class="cf-ads-row">
        <div class="cf-ads-copy">
          <strong>Interstitial</strong>
          <small>Zone <?= e((string) $ads['interstitialZone']) ?> · site-wide when on</small>
        </div>
      ...
      <div class="cf-ads-row">
        <div class="cf-ads-copy">
          ...
          <small>Zone <?= e((string) $ads['videoSliderZone']) ?> · site-wide when on</small>
        </div>
    ...
    <section class="cf-admin-panel cf-ads-panel cf-ads-pop-panel" aria-label="Pop ads" style="margin-top:1rem">
      <div class="cf-ads-row" style="border-bottom:0;padding-bottom:.35rem">
        <div class="cf-ads-copy">
          ...
          <small>Zone <?= e((string) ($ads['popZone'] ?? '11979882')) ?> · anti-adblock · disable anytime</small>
        </div>
      ...
      <p class="muted" style="margin:1rem 0 0;font-size:.78rem;color:rgba(255,255,255,.45)">
        Anti-adblock: <code><?= e((string) ($ads['antiAdblockSrc'] ?? '')) ?></code> · Admin pages never show ads.
      </p>
    </section>
  </div>
</main>
